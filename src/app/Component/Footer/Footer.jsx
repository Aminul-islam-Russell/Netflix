        ...
        <div className="container md:w-5/6 px-2 md:px-0 mx-auto py-9">
            <div className='grid md:grid-cols-4 grid-cols-1 justify-center gap-10 pt-8'>
              <div className='flex flex-col'>
                <img src="https://i.ibb.co/jWXTxG3/logo.png" alt="logo" className='w-1/2' />
              ...
              <div>
                  ...
                  <ul  className='flex flex-col md:gap-5 gap-2'>
                    ...
                    <li className='flex gap-5 text-md text-gray-300 items-center my-6 ml-3'>
                        <span><a href="mailto:mahadidev7@gmail.com"> <FaFacebookF className='text-2xl' /></a></span>
                        <span><a href="mailto:mahadidev7@gmail.com"><BsInstagram className='text-2xl'/> </a></span>
                        <span><a href="mailto:mahadidev7@gmail.com"><AiOutlineTwitter className='text-2xl'/></a></span>
                    </li>
                  </ul>
                </div>
              </div>
